...
let my_string;
my_string = prompt("Введите данные");
...
{if(empty_string(my_string) &&
    ...
    numbers(my_string) &
    symbol(my_string)){
        alert('Строка соответсвует требованиям!')}}

valid_script(my_string) 

function empty_string(my_string){
    if(my_string.trim() == ""){
        alert("Cтрока не должна быть пустой!")
    }else{
        return true}
}//Пустая строка;
function min_length(my_string){
    if(my_string.length < 5){
        alert("Строка должна содержать минимум 5 символов!")
    }
    else{
        return true}
}//Минимальная длина;
function max_length(my_string){
    if(my_string.length > 64){
        alert("Строка должна содержать максимум 64 символа!")
    }
    else{
        return true}
}//Максимальная длина;
...
if(/[A-ZА-Я]/.test(my_string) != true){
    alert("В строке должна быть хотя бы одна буква в верхнем регистре!")
    }
    else{
        return true}
}//Заглавные буквы;
function numbers(my_string){
    if(/\d/.test(my_string) != true){
        alert("В строке должна быть хотя бы одна цифра!")
    }
    else{
        return true}
}//Цифра;
function symbol(my_string){
    if(/[@]/.test(my_string) != true){
        alert("В строке должна быть хотя бы одна @!")
    }
    else{
        return true
    }
